...
import Adafruit_MotorHAT, Adafruit_DCMotor, Adafruit_StepperMotor
...
#myStepper.step(0, Adafruit_MotorHAT.FORWARD,  Adafruit_MotorHAT.SINGLE)
myStepper.step(2, Adafruit_MotorHAT.BACKWARD, Adafruit_MotorHAT.SINGLE)
  ...
  #  print("Microsteps")
   # myStepper.step(10, Adafruit_MotorHAT.FORWARD,  Adafruit_MotorHAT.MICROSTEP)
