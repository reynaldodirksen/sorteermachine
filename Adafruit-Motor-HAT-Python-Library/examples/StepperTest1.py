...
import os
os.chdir("/home/pi/Adafruit-Motor-HAT-Python-Library/examples")
...
#time.sleep(1)
#myStepper.step(5, Adafruit_MotorHAT.FORWARD, Adafruit_MotorHAT.SINGLE)
...
#myStepper.step(10, Adafruit_MotorHAT.BACKWARD, Adafruit_MotorHAT.DOUBLE)
  ...
  #  print("Microsteps")
#myStepper.step(2, Adafruit_MotorHAT.FORWARD,  Adafruit_MotorHAT.MICROSTEP)
#time.sleep(1)
